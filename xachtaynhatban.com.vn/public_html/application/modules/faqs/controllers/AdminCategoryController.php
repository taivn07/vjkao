<?php
class Faqs_AdminCategoryController extends Zendvn_Controller_Action{
	...
	public function indexAction(){
		$this->view->Title = 'Hỏi đáp :: Danh mục';
		$this->view->headTitle($this->view->Title, true);
		$tblCategory = new Faqs_Model_Category();
	...
	public function addAction(){
		$this->view->Title = 'Hỏi đáp :: Danh mục :: Thêm mới';
		$this->view->headTitle($this->view->Title, true);
		$tblCategory = new Faqs_Model_Category();
		$this->view->slbCategory = $tblCategory->itemInSelectbox($this->_arrParam);
		
		if($this->_request->isPost()){
			$validator = new Faqs_Form_ValidateCategory($this->_arrParam);
	...
	public function infoAction(){
		$this->view->Title = 'Hỏi đáp :: Danh mục :: Xem thông tin';
		$this->view->headTitle($this->view->Title, true);
		$tblCategory = new Faqs_Model_Category();
	...
	public function editAction(){
		$this->view->Title = 'Hỏi đáp :: Danh mục :: Sửa';
		$this->view->headTitle($this->view->Title, true);
		$tblCategory = new Faqs_Model_Category();
	...
	public function deleteAction(){
		$this->view->Title = 'Hỏi đáp :: Danh mục :: Xóa';
		$this->view->headTitle($this->view->Title, true);
		if($this->_request->isPost()){
