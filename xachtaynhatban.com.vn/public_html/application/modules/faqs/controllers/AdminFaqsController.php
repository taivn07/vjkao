<?php
class Faqs_AdminFaqsController extends Zendvn_Controller_Action{
	...
	public function indexAction(){
		$this->view->Title = 'Câu hỏi :: Danh sách';
		$this->view->headTitle($this->view->Title, true);
		
		$tblFaqs = new Faqs_Model_Faqs();
		$this->view->Items = $tblFaqs->listItem($this->_arrParam, array('task'=>'admin-list'));
		...
		$totalItem = $tblFaqs->countItem($this->_arrParam, array('task'=>'admin-list'));
	...
	public function addAction(){
		$this->view->Title = 'Câu hỏi :: Thêm mới';
		$this->view->headTitle($this->view->Title, true);
		...
		if($this->_request->isPost()){
			...
			if($validator->isError() == true){
				...
				$tblFaqs->saveItem($arrParam,array('task'=>'admin-add'));
				$this->_redirect($this->_actionMain);
			}
		}
	}
	...
	public function infoAction(){
		$this->view->Title = 'Câu hỏi :: Xem thông tin';
		$this->view->headTitle($this->view->Title, true);
		$tblFaqs = new Faqs_Model_Faqs();
		$this->view->Item = $tblFaqs->getItem($this->_arrParam,array('task'=>'admin-info'));
		
	}
	
	public function editAction(){
		$this->view->Title = 'Câu hỏi :: Sửa';
		$this->view->headTitle($this->view->Title, true);
		
		$tblFaqs = new Faqs_Model_Faqs();
		$this->view->Item = $tblFaqs->getItem($this->_arrParam,array('task'=>'admin-edit'));
		...
		if($this->_request->isPost()){
			...
			if($validator->isError() == true){
				...
				$arrParam = $validator->getData();
				$tblFaqs->saveItem($arrParam,array('task'=>'admin-edit'));
	...
	public function deleteAction(){
		$this->view->Title = 'Câu hỏi :: Xóa';
		$this->view->headTitle($this->view->Title, true);
		if($this->_request->isPost()){
			if(($this->_arrParam['type'] == 'multi-delete') && ($this->_arrParam['task'] == 'ok')){
				$tblFaqs = new Faqs_Model_Faqs();
				$tblFaqs->deleteItem($this->_arrParam, array('task'=>'admin-delete-muti'));
				$this->_redirect($this->_actionMain . $this->_page);
			}else
				if(!empty($this->_arrParam['id'])){
				$tblFaqs = new Faqs_Model_Faqs();
				$tblFaqs->deleteItem($this->_arrParam, array('task'=>'admin-delete'));
				$this->_redirect($this->_actionMain . $this->_page);
			}
		}
	}
	...
	public function statusAction(){
		$tblFaqs = new Faqs_Model_Faqs();
		$tblFaqs->changeStatus($this->_arrParam);
		$this->_redirect($this->_actionMain . $this->_page);
		$this->_helper->viewRenderer->setNoRender();
	}
	...
	public function sortAction(){
		if($this->_request->isPost()){
			$tblFaqs = new Faqs_Model_Faqs();
			$tblFaqs->sortItem($this->_arrParam, array('task'=>'admin-sort'));
			$this->_redirect($this->_actionMain . $this->_page);
		}
		$this->_helper->viewRenderer->setNoRender();
	}
