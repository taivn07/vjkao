...
class Shopping_PublicController extends Zendvn_Controller_Action {
	...
	public function popupCartAction(){
		$this->_helper->layout->disableLayout();
		...
		$this->view->itemKhac = $tblProduct->listItem($this->_arrParam,array('task'=>'public-khac-cart'));
	}
	...
	public function addItemAction(){
		...
		$soluong = 1;
		if(!empty($this->_arrParam['soluong'])) {
			$soluong = $this->_arrParam['soluong'];
		}
