<?php
class Shopping_AdminUnitsController extends Zendvn_Controller_Action{
	...
	public function indexAction(){
		$this->view->Title = 'Đơn vị sản phẩm :: Danh sách';
	...
	public function addAction(){
		$this->view->Title = 'Đơn vị sản phẩm :: Thêm mới';
		$this->view->headTitle($this->view->Title, true);
		...
		if($this->_request->isPost()){
			...
			$validator = new Shopping_Form_ValidateUnits($this->_arrParam);
	...
	public function editAction(){
		$this->view->Title = 'Đơn vị sản phẩm :: Sửa';
		$this->view->headTitle($this->view->Title, true);
	...
	public function deleteAction(){
		$this->view->Title = 'Đơn vị sản phẩm :: Xóa';
		$this->view->headTitle($this->view->Title, true);
		if($this->_request->isPost()){
