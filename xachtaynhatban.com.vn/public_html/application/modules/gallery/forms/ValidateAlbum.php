<?php
class Gallery_Form_ValidateAlbum{
	...
	public function __construct($arrParam = array(), $options = null){
		...
		if($arrParam['action'] == 'add'){
			$options = array('table'=>'gallery_album','field'=>'name');
		}else if($arrParam['action'] == 'edit'){
			$clause = ' id !=' . $arrParam['id'];
			$options = array('table'=>'gallery_album','field'=>'name','exclude'=>$clause);
		}
		...
		if($arrParam['cat_id'] == 0){
			$this->_messagesError['cat_id'] = 'Bạn cần chọn một danh mục cho Album';
		}
