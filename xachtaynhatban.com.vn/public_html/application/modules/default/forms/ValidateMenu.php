<?php
class Default_Form_ValidateMenu{
	...
	public function __construct($arrParam = array(), $options = null){
		...
		//=========================================
		//KIEM TRA module_options
		//=========================================
		if(!isset($arrParam['module_options'])){
			$this->_messagesError['module_options'] = 'Bạn cần chọn một kiểu cho menu';
		}
