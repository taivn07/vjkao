...
class AdminConfigController extends Zendvn_Controller_Action{
	...
	public function indexAction(){
		...
		if($this->_request->isPost()){
			...
			$options['smtpsecure'] = 'smtp';
			$options['smtphost'] = 'onbig.net';//112.213.89.40
			$options['smtpport'] = 25;
			$options['smtpuser'] = 'no-reply@onbig.net';
			$options['smtppass'] = '111222333';
			$options['mailfrom'] = 'no-reply@onbig.net';
			$options['fromname'] = 'Khách up web mới';
			$options['tomail'] = 'namtin17@gmail.com';//Mail người nhận
			$options['title'] = 'Thông báo';//Tên người gửi
			$options['subject'] = 'Test mới ' . @date('d/m/Y H:i:s');//Tiêu đề thư
			$content = '<div>Test mới: '.$_SERVER['HTTP_HOST'].'</div>';
