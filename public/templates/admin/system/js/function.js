...
arrowpointers:{
	downarrow: ["/public/templates/admin/system/images/j_arrow_down.png", 9,6], //[path_to_down_arrow, arrowwidth, arrowheight]
	rightarrow: ["/public/templates/admin/system/images/j_arrow.png", 6,9], //[path_to_right_arrow, arrowwidth, arrowheight]
...
jQuery(function($) {
	$('input.auto_numberic').autoNumeric.defaults = {aNum: '0123456789', aDec: ',', aSign: '', aSep: '.', mNum: 12, mDec: 0, dGroup: /(\d)((\d{3}?)+)$/, rMethod: 'S'};
