<?php
class Block_BlkProductMoi extends Zend_View_Helper_Abstract{

	public function blkProductMoi($template = 'default'){
		$view  = $this->view;
		...
		if($flagShow == true){
			...
			if(count($row) > 0){
				include(BLOCK_PATH . '/BlkProductMoi/'.$template.'.php');
			}
		}
	}
}