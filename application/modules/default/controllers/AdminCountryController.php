<?php
class AdminCountryController extends Zendvn_Controller_Action{
	...
	public function indexAction(){
		$this->view->Title = 'Quốc gia';
		$this->view->headTitle($this->view->Title, true);
		
		$tblCountry = new Default_Model_Countries();
		$this->view->Items = $tblCountry->listItem($this->_arrParam, array('task'=>'admin-list'));
		
		$totalItem = $tblCountry->countItem($this->_arrParam, array('task'=>'admin-list'));
	...
	public function addAction(){
		$this->view->Title = 'Quốc gia :: Thêm mới';
		$this->view->headTitle($this->view->Title, true);
		...
		if($this->_request->isPost()){
			...
			$validator = new Default_Form_ValidateCountry($this->_arrParam);
			if($validator->isError() == true){
				$this->view->messageError = $validator->getMessageError();
				$this->view->Item = $validator->getData();
			}else{
				$arrParam = $validator->getData();
				$tblCountry->saveItem($arrParam,array('task'=>'admin-add'));
				$this->_redirect($this->_actionMain);
			}
		}
	}
	...
	public function editAction(){
		$this->view->Title = 'Quốc gia :: Sửa';
		$this->view->headTitle($this->view->Title, true);
		
		$tblCountry = new Default_Model_Countries();
		$this->view->Item = $tblCountry->getItem($this->_arrParam,array('task'=>'admin-edit'));
		...
		if($this->_request->isPost()){
			...
			if($validator->isError() == true){
				...
				$arrParam = $validator->getData();
				$tblCountry->saveItem($arrParam,array('task'=>'admin-edit'));
	...
	public function deleteAction(){
		$this->view->Title = 'Quốc gia :: Xóa';
		$this->view->headTitle($this->view->Title, true);
		if($this->_request->isPost()){
			if(($this->_arrParam['type'] == 'multi-delete') && ($this->_arrParam['task'] == 'ok')){
				$tblCountry = new Default_Model_Countries();
				$tblCountry->deleteItem($this->_arrParam, array('task'=>'admin-delete-muti'));
				$this->_redirect($this->_actionMain . $this->_page);
			}else
				if(!empty($this->_arrParam['id'])){
				$tblCountry = new Default_Model_Countries();
				$tblCountry->deleteItem($this->_arrParam, array('task'=>'admin-delete'));
				$this->_redirect($this->_actionMain . $this->_page);
			}
		}
	}
	...
	public function statusAction(){
		$tblCountry = new Default_Model_Countries();
		$tblCountry->changeStatus($this->_arrParam);
		$this->_redirect($this->_actionMain . $this->_page);
		$this->_helper->viewRenderer->setNoRender();
	}
	...
	public function sortAction(){
		if($this->_request->isPost()){
			$tblCountry = new Default_Model_Countries();
			$tblCountry->sortItem($this->_arrParam, array('task'=>'admin-sort'));
			$this->_redirect($this->_actionMain . $this->_page);
		}
		$this->_helper->viewRenderer->setNoRender();
	}
