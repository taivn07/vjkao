<?php
class Default_Form_ValidateCommentReply{
	...
	public function __construct($arrParam = array(), $options = null){
		...
		if(!$validator->isValid($arrParam['content_reply'])){
			$message = $validator->getMessages();
			$this->_messagesError['content_reply'] = 'Nội dung: ' . current($message);
			$arrParam['content_reply'] = '';
		}
