<?php
class Gallery_AdminCategoryController extends Zendvn_Controller_Action{
	...
	public function indexAction(){
		$this->view->Title = 'Thư viện ảnh :: Danh mục';
		$this->view->headTitle($this->view->Title, true);
		$tblCategory = new Gallery_Model_Category();
	...
	public function addAction(){
		$this->view->Title = 'Thư viện ảnh :: Danh mục :: Thêm mới';
		$this->view->headTitle($this->view->Title, true);
		$tblCategory = new Gallery_Model_Category();
		$this->view->slbCategory = $tblCategory->itemInSelectbox($this->_arrParam);
	...
	public function infoAction(){
		$this->view->Title = 'Thư viện ảnh :: Danh mục :: Xem thông tin';
		$this->view->headTitle($this->view->Title, true);
		$tblCategory = new Gallery_Model_Category();
	...
	public function editAction(){
		$this->view->Title = 'Thư viện ảnh :: Danh mục :: Sửa';
		$this->view->headTitle($this->view->Title, true);
		$tblCategory = new Gallery_Model_Category();
	...
	public function deleteAction(){
		$this->view->Title = 'Thư viện ảnh :: Danh mục :: Xóa';
		$this->view->headTitle($this->view->Title, true);
		if($this->_request->isPost()){
