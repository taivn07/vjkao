<?php
	...
	$btnAddNew = $this->cmsButton ( 'Trả lời', $linkAddNew, $this->imgUrl . '/toolbar/icon-32-new.png', 'link' );
	...
	// 9. Back - Link
	$linkBackAlbum = $this->baseUrl ( 'faqs/admin-faqs/index');
	...
	switch ($this->arrParam['action']){
		...
		case 'index': $strBtn = $btnAddNew . $divider . $btnDeleteItems . ' ' . $btnBackAlbum;
					 			break;
	...
	//Icon toolbar
	$IconToolbar = 'icon-48-help-forum';
?>
