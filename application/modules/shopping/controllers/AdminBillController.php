<?php
class Shopping_AdminBillController extends Zendvn_Controller_Action{
	...
	public function indexAction(){
		$this->view->Title = 'Đơn đặt hàng :: Danh sách';
	...
	public function addAction(){
		/* $this->view->Title = 'Đơn đặt hàng :: Thêm mới';
		$this->view->headTitle($this->view->Title, true);
		...
		if($this->_request->isPost()){
			...
			$validator = new Shopping_Form_ValidateShop($this->_arrParam);
	...
	public function infoAction(){
		$this->view->Title = 'Đơn đặt hàng :: Xem thông tin';
		$this->view->headTitle($this->view->Title, true);
		$tblBill = new Shopping_Model_Bill();
	...
	public function editAction(){
		/* $this->view->Title = 'Đơn đặt hàng :: Sửa';
		$this->view->headTitle($this->view->Title, true);
	...
	public function deleteAction(){
		$this->view->Title = 'Đơn đặt hàng :: Xóa';
		$this->view->headTitle($this->view->Title, true);
		if($this->_request->isPost()){
